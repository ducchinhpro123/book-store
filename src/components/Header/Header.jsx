...
import {logout, useAuth} from "../../firestore.jsx";

export default function Header() {

  const currentUserTest = useAuth()
          ...
          <div
            ...
            <div className="col-xl-4 d-lg-flex align-items-lg-center justify-content-xl-start">
              <Link to={config.routes.homePage}>
                <img alt={'image bg'} style={{width: '128px', height: "87px"}} width={257} height={87}
            ...
            <div
                className="col-lg-6 col-xl-5 offset-lg-0 d-xl-flex justify-content-lg-center align-items-lg-center justify-content-xl-end">
              {/*  <button
              ...
              {currentUserTest && <button className={"ml-4 btn btn-outline-dark"} onClick={handleLogout}>Log Out</button>}
