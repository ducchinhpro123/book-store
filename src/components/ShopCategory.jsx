      ...
      <div className="container">
        ...
        >
          ...
          >
            <div className="row">
              <div
                  className="col-6 col-sm-7 col-xl-6 d-xl-flex flex-column justify-content-xl-center align-items-xl-start"
              ...
              <div className="col-5 col-sm-5 col-lg-8 col-xl-6 d-xl-flex justify-content-xl-center align-items-xl-center">
                <img
                    className="img-fluid"
                    src={`${process.env.PUBLIC_URL}/assets/img/e-books.png`}
                    style={{
          ...
          >
            <div className="row">
              ...
              <div className="col-5 col-sm-5 col-xl-6 d-xl-flex align-items-xl-center">
                <img
                    className="img-fluid"
