export const blogJson = [
  {
    title: "Best selling book - March",
    book: `${process.env.PUBLIC_URL}/assets/img/d61d44254608dd06ccdd2ff02982d14d_XL.jpg`,
    summary_content: "The month of March saw some shakeups on the bestseller lists," +
        "                  with new " +
  ...
  },
  {
    ...
    avatar: `${process.env.PUBLIC_URL}/assets/img/icons8-avatar-480.png`,
    author: "Linda",
    from: "London"
  },
  {
    ...
    summary_content: "This months hottest digital reads showcase the diverse" +
        ...
        "                  historical...",
    avatar: `${process.env.PUBLIC_URL}/assets/img/icons8-user-foo-foo-480.png`,
    author: "David",
    from: "California"
  },
